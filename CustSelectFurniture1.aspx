<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CustSelectFurniture1.aspx.cs" Inherits="CustSelectFurniture1" %>
...
<body bgcolor="#ccffcc">
    ...
    <div>
        ...
        <asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" BackColor="#DEBA84"
            ...
            DataSourceID="SqlDataSource1" Height="268px" Style="z-index: 103; left: 149px;
            position: absolute; top: 251px" Width="564px">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:EventConnectionString %>"
            SelectCommand="SELECT [EventName], [FurnitureName], [price], [description], [details] FROM [FurnitureTab] WHERE ([FurnitureName] = @FurnitureName)">
            <SelectParameters>
                <asp:QueryStringParameter Name="FurnitureName" QueryStringField="vvar" Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>
        &nbsp; &nbsp;&nbsp;
        ...
        <asp:TextBox ID="TextBox1" runat="server" Style="z-index: 109; left: 455px; position: absolute;
