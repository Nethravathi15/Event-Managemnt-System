<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdminManpower.aspx.cs" Inherits="AdminManpower" %>
...
<body bgcolor="#ccffcc">
    ...
    &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
        <asp:HyperLink ID="HyperLink1" runat="server" Font-Bold="False" Font-Names="Arial Black"
            Style="z-index: 103; left: 103px; position: absolute; top: 187px" BackColor="DarkGray" Font-Size="X-Large" ForeColor="#804040" Width="582px">Man Power Details</asp:HyperLink>
        ...
        <asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Names="Verdana" ForeColor="Teal"
            Style="z-index: 105; left: 130px; position: absolute; top: 295px" Text="Skilled Person Type" Width="183px"></asp:Label>
        &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
        ...
        <asp:Label ID="Label3" runat="server" Font-Bold="True" Font-Names="Verdana" ForeColor="Teal"
            Style="z-index: 108; left: 130px; position: absolute; top: 336px" Text="Wage / day" Width="168px"></asp:Label>
        &nbsp;
        <asp:Button ID="Button1"   OnClick="Button1_Click"  runat="server" Font-Names="Verdana" Font-Size="12pt" Style="z-index: 110;
            left: 437px; position: absolute; top: 539px" Text="Save" Width="170px" Height="35px" />
        &nbsp;
        <asp:TextBox ID="TextBox3" runat="server" Style="z-index: 111; left: 322px; position: absolute;
            top: 380px" Width="280px" Height="122px" TextMode="MultiLine"></asp:TextBox>
        <asp:Label ID="Label4" runat="server" Font-Bold="True" Font-Names="Verdana" ForeColor="Teal"
            Style="z-index: 112; left: 130px; position: absolute; top: 387px" Text="Details" Width="166px"></asp:Label>
        &nbsp;
