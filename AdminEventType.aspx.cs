...
public partial class AdminEventType : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        SqlDataReader dr;
        cmd.Connection = Conn;
        cmd.CommandText = "select * from EventTab where eventName='" + TextBox1.Text + "'";
        ...
        Conn.Close();
        Conn.Open();
        SqlStr = "insert into eventTab values(";
