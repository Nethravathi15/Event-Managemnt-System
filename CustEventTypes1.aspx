<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CustEventTypes1.aspx.cs" Inherits="CustEventTypes1" %>
...
<body bgcolor="#ccffcc">
    ...
    <div>
        ...
        <asp:LinkButton ID="LinkButton1" runat="server" Font-Bold="True" Font-Names="Verdana"
            Font-Size="Small" PostBackUrl="~/CustMainpage.aspx" Style="z-index: 108; left: 0px;
