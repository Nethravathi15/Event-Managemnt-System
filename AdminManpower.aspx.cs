...
public partial class AdminManpower : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        if (TextBox1.Text == "")
        {
            MessageBox.Show("Please enter the Person Type Name");
            return;
        }
        ...
        SqlDataReader dr;
        cmd.Connection = Conn;
        cmd.CommandText = "select * from ManpowerTab where eventName='" + DropDownList1.Text + "' and ManPowerName='" + TextBox1.Text + "'";
        ...
        Conn.Open();
        SqlStr = "insert into manpowerTab values(";
