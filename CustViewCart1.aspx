<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CustViewCart1.aspx.cs" Inherits="CustViewCart1" %>
...
<body bgcolor="#ccffcc">
    ...
    <div>
        ...
        <asp:Button ID="Button1" runat="server" Font-Size="Large" Height="45px" PostBackUrl="~/UserPayment.aspx"
            Style="z-index: 107; left: 761px; position: absolute; top: 642px" Text="Make Advance Payment"
            Width="263px" />
        ...
        <asp:HyperLink ID="HyperLink1" runat="server" BackColor="Purple" Font-Bold="False"
            ...
            left: 148px; position: absolute; top: 181px" Width="576px">&nbsp; Customer Select List</asp:HyperLink>
        ...
        <asp:LinkButton ID="LinkButton2" runat="server" Font-Bold="True" Font-Names="Verdana"
            Font-Size="Small" PostBackUrl="~/CustMain1.aspx" Style="z-index: 105; left: 152px;
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:EventConnectionString %>"
            ...
            <SelectParameters>
                <asp:SessionParameter Name="EventName" SessionField="CustEventName" Type="String" />
            </SelectParameters>
        </asp:SqlDataSource>
