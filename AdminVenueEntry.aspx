<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdminVenueEntry.aspx.cs" Inherits="AdminVenueEntry" %>
...
<body bgcolor="#ccffcc">
    ...
    &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
        <asp:HyperLink ID="HyperLink1" runat="server" Font-Bold="False" Font-Names="Arial Black"
            Style="z-index: 103; left: 103px; position: absolute; top: 187px" BackColor="DarkGray" Font-Size="X-Large" ForeColor="#804040" Width="582px">Event Venue Details</asp:HyperLink>
        ...
        <asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Names="Verdana" ForeColor="Teal"
            Style="z-index: 105; left: 130px; position: absolute; top: 295px" Text="Venue Name" Width="163px"></asp:Label>
        &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
        <asp:TextBox ID="TextBox1" runat="server" Style="z-index: 106; left: 321px; position: absolute;
            top: 291px" Width="281px"></asp:TextBox>
        &nbsp;&nbsp;
        ...
        <asp:Label ID="Label4" runat="server" Font-Bold="True" Font-Names="Verdana" ForeColor="Teal"
            Style="z-index: 112; left: 130px; position: absolute; top: 387px" Text="Facilities"></asp:Label>
        &nbsp;
        ...
        <asp:Label ID="Label5" runat="server" Font-Bold="True" Font-Names="Verdana" ForeColor="Teal"
            Style="z-index: 114; left: 130px; position: absolute; top: 478px" Text="Address"></asp:Label>
        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
        &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;
