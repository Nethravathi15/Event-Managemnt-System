...
<body bgcolor="#ccffcc">
    ...
    <div>
        ...
        <asp:HyperLink ID="HyperLink1" runat="server" BackColor="Purple" Font-Bold="False"
            ...
            left: 148px; position: absolute; top: 181px" Width="576px">&nbsp; Venue List</asp:HyperLink>
        &nbsp; &nbsp;
        ...
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
            ...
            CellPadding="4" DataSourceID="SqlDataSource1" Style="z-index: 106; left: 151px;
            position: absolute; top: 251px" Width="809px">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:EventConnectionString %>"
            SelectCommand="SELECT [EventName], [VenueName], [price], [Facilities], [vaddress] FROM [VenueTab] ORDER BY [VenueName]">
        </asp:SqlDataSource>
