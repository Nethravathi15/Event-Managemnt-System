...
public partial class AdminFurnitureEntry : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        SqlDataReader dr;
        cmd.Connection = Conn;
        cmd.CommandText = "select * from FurnitureTab where eventName='" + DropDownList1.Text + "' and furnitureName='" + TextBox1.Text + "'";
        ...
        Conn.Open();
        SqlStr = "insert into furnitureTab values(";
