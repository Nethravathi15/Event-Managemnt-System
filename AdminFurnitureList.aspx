...
<body bgcolor="#ccffcc">
    ...
    <div>
        ...
        <asp:HyperLink ID="HyperLink1" runat="server" BackColor="Purple" Font-Bold="False"
            ...
            left: 148px; position: absolute; top: 181px" Width="576px">&nbsp; Furniture List</asp:HyperLink>
        &nbsp; &nbsp;
        ...
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False"
            ...
            CellSpacing="1" DataSourceID="SqlDataSource1" GridLines="None" Style="z-index: 106;
            left: 150px; position: absolute; top: 243px" Width="817px">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:EventConnectionString %>"
            SelectCommand="SELECT [EventName], [FurnitureName], [price], [description], [details] FROM [FurnitureTab] ORDER BY [FurnitureName]">
        </asp:SqlDataSource>
