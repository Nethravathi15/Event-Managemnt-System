<%@ Page Language="C#" AutoEventWireup="true" CodeFile="AdminFoodEntry.aspx.cs" Inherits="AdminFoodEntry" %>
...
<body bgcolor="#ccffcc">
    ...
    &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
        <asp:HyperLink ID="HyperLink1" runat="server" Font-Bold="False" Font-Names="Arial Black"
            Style="z-index: 103; left: 103px; position: absolute; top: 187px" BackColor="DarkGray" Font-Size="X-Large" ForeColor="#804040" Width="582px">Food Details</asp:HyperLink>
        ...
        <asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Names="Verdana" ForeColor="Teal"
            Style="z-index: 105; left: 130px; position: absolute; top: 295px" Text="Food Name" Width="163px"></asp:Label>
        &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;
