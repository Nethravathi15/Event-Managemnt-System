...
public partial class AdminFoodEntry : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        SqlDataReader dr;
        cmd.Connection = Conn;
        cmd.CommandText = "select * from FoodTab where eventName='" + DropDownList1.Text + "' and foodName='" + TextBox1.Text + "'";
        ...
        Conn.Open();
        SqlStr = "insert into foodTab values(";
